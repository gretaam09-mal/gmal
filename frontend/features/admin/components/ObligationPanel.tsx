...
const FIELD_ORDER: (keyof ObligationFields)[] = ["who", "what", "when", "threshold", "enforcer"];
...
function ExtractedFieldRow({
  ...
  return (
    <div className="grid grid-cols-[80px_1fr_100px_60px] items-start gap-2 py-1">
      ...
      <span className="font-ui text-xs tabular-nums text-ink/40">{field.confidence}%</span>
    </div>
  );
}
